...
public class C09_SinirlarinDisindaKalanElemanSayisi {
    ...
    public static void main(String[] args) {
        ...
        // verilen baslangic ve bitis degerleri (sinirlar dahil)
        // arasinda olmayan eleman sayisini yazdirin
        ...
        System.out.println("Baslangic ve bitis noktalari disinda " + sayac + " adet sayi var");
