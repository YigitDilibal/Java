...
public class C01_equals {
    ...
    public static void main(String[] args) {
        ...
        if (cinsiyet == 'E' ) System.out.println("Emekli olabiilirsin");
        ...
        System.out.println(str1==str2); // Alí==Ali ==> true
        System.out.println(str1==str3); // Alí==Ali ==> true
        System.out.println(str1==str4); // Alí==Ali ==> true
        System.out.println(str1==str5); // Alí==Ali ==> true
        System.out.println(str1=="Ali"); // Alí==Ali ==> true
        ...
        System.out.println(str1.equals(str10)); // Ali equals Ali. ==> false
