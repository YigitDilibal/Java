...
public class NestedMapDepo {
    ...
    public static void mapeOgrenciEkle(int ogrenciNo,String isim, String soyisim, String sinif, String sube, String bolum){
        ...
        ogrenciNestedMap.put(ogrenciNo, eklenecekOgrenciMap);
